    ...
    var joinFunction = function() {
      ...
      */
      while(resultTweetsList.length < requiredTweets) {
        ...
        //
        // Something here for issue #263?
        //
        //if(nextTweet.)
        if(nextTweet.text.match(/rain/i)){
          continue;
        }
        //
        // End of 263 code
        ...
        if(isLastInTimelineCache) {
          ...
          */
          if(_this.lastRequestedId[nextTweet.timelineId] == nextTweet.id) {
            ...
            delete _this.lastRequestedId[nextTweet.timelineId];
            continue;
          }
          ...
          wantedTimeline.giveMeTweets(function(returnedTweets) {
            if(returnedTweets) { // Success
              _this.lastRequestedId[nextTweet.timelineId] = nextTweet.id;
            }
